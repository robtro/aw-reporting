  ...
  public static void main(String args[]) {
    ...
    try {
      ...
      String mccAccountId = properties.getProperty("mccAccountId").replaceAll("-", "");
        ...
        LOGGER.debug("GeneratePDF is default");

        // Get HTML template and output directory
        File htmlTemplateFile = new File(cmdLine.getOptionValue("HTMLTemplate"));
        File outputDirectory = new File(cmdLine.getOptionValue("outputDirectory"));
...
OptionBuilder.withArgName("outputDirectory");
  ...
  private static void printHelpMessage(Options options) {
    ...
    formatter.printHelp(" java -Xmx1G -jar aw-reporting.jar -startDate YYYYMMDD -endDate YYYYMMDD "
        ...
        + "-template <htmlTemplateFile> -folder <outputDirectory> -sumAdExtensions "
