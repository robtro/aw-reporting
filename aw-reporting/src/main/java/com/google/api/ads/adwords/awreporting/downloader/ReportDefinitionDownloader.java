...
public class ReportDefinitionDownloader {
      ...
      try {
        ...
        if (this.retriesCount == i) {
          ...
          throw new ApiException(
              errorMsg, new com.google.api.ads.adwords.jaxws.v201603.cm.ApiException());
        }
      }
  ...
  // TODO: cz
  // check if we should use com.google.api.ads.adwords.jaxws.v201603.cm.ReportDefinitionReportType
  // everywhere in this project?
  private com.google.api.ads.adwords.jaxws.v201603.cm.ReportDefinitionReportType
  convertReportType(ReportDefinitionReportType reportType) {
    return com.google.api.ads.adwords.jaxws.v201603.cm.ReportDefinitionReportType.valueOf(
        reportType.name());
  }
